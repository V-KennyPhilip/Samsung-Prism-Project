...
# Data parameters
data_folder = '/content/drive/MyDrive/srgan_output/' # folder with JSON data files
...
srresnet_checkpoint = "/content/drive/MyDrive/models/checkpoint_srresnet.pth.tar"  # filepath of the trained SRResNet checkpoint used for initialization
...
# Learning parameters
checkpoint = '/content/drive/MyDrive/models/checkpoint_srgan.pth.tar'  # path to model (SRGAN) checkpoint, None if none
...
if os.path.isfile(checkpoint):
    ...
    # Set start_epoch to 0 if starting fresh
    start_epoch = 0
    ...
    for epoch in range(start_epoch, epochs):
        ...
        torch.save({'epoch': epoch,
                    ...
                    'optimizer_g': optimizer_g,
                    'optimizer_d': optimizer_d},
                   '/content/drive/MyDrive/models/checkpoint_srgan.pth.tar')
