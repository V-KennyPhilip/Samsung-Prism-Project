...
# Define paths
input_folder = "/content/drive/MyDrive/Set14"
output_folder = "/content/drive/MyDrive/Set14_results"

# Create output folder if it doesn't exist
os.makedirs(output_folder, exist_ok=True)

# Model checkpoints
srgan_checkpoint = "/content/drive/MyDrive/models/checkpoint_srgan.pth.tar"
srresnet_checkpoint = "/content/drive/MyDrive/models/checkpoint_srresnet.pth.tar"
...
def visualize_sr(img, halve=False, output_path= NONE):
    """
    ...
    #Display grid
    #grid_img.show()
    #grid_img.save('/content/drive/MyDrive')
...
if __name__ == '__main__':
    #grid_img = visualize_sr("/content/drive/MyDrive/Set14")
    for img_name in os.listdir(input_folder):
        img_path = os.path.join(input_folder, img_name)
        output_path = os.path.join(output_folder, f"result_{img_name}")
        visualize_sr(img_path, output_path=output_path)