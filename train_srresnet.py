...
# Learning parameters
checkpoint = '/content/drive/MyDrive/models/checkpoint_srresnet.pth.tar'  # path to model checkpoint, None if none
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        torch.save({'epoch': epoch, 'model': model, 'optimizer': optimizer}, checkpoint)
